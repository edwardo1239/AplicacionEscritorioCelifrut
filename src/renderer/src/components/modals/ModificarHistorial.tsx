...
export default function ModificarHistorial(props:vaciadoType) {
    ...
    const modificarHistorial = async () => {
      try {
        ...
        if (canastillasInt > propsCanastillasInt) {
          ...
          const obj = { canastillas:canastillas, enf:props.propsModal.enf, action:'modificarHistorialVaciado', id:props.propsModal.id }
