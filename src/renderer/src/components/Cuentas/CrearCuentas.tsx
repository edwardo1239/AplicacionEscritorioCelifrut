...
const App = () => {
  ...
  const [iconVisible, setIconVisible] = useState({ user: true, lock: true });
...
/>
  ...
  // Animaciones para el botón de guardar
  ...
  return (
    <div className="flex items-center justify-center h-screen">
      <div className="bg-white p-6 rounded-lg shadow-lg" style={{ width: '600px', height: '700px', marginBottom: '100px', marginTop: '150px' }}>
